          ...
          return  SizedBox(
            ...
            child: Card(
              clipBehavior: Clip.hardEdge,
                child: Column(
                  children: [
                    image.Image.network(datum[item].image.medium,height: 230,fit: BoxFit.cover,),
                    Text(datum[item].name,style: TextStyle(color: Colors.black,height: 3)),
                    SizedBox(
                      child: Row(
                    ...
                    Text("Discount : ${datum[item].discount}",style: TextStyle(height: 3),),
                  ],
                ),
              ),
          );
